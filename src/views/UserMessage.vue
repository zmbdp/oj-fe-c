...
<script setup>
import { getMessageListService, deleteMessageService } from "@/apis/message"
...
// 删除消息
async function handlerDelete(message) {
  await deleteMessageService(message.textId)  // 调用删除接口，传递 textId
  // 刷新列表
  getMessageList()
}
